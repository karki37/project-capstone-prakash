...
const Register = () => {
  ...
  const [pwdFocus, setPwdFoucs] = useState(false);

  const [matchPwd, setMatchPwd] = useState(" ");
  const [valiMatch, setValidMatch] = useState(false);
  const [matchFocus, setMatchFoucs] = useState(false);
        ...
        <section>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <FontAwesomeIcon icon={faInfoCircle} />
              4 to 24 characters. <br />
              Must include uppercase and lowercase letters, a umber and a
